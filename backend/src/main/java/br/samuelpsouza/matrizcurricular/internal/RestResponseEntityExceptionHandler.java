package br.samuelpsouza.matrizcurricular.internal;

import br.samuelpsouza.matrizcurricular.exceptions.*;
import br.samuelpsouza.matrizcurricular.internal.err.ApiError;
...
public class RestResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(SecurityRoleNotFoundException.class)
    public ResponseEntity<Object> handleSecurityRoleNotFoundException(SecurityRoleNotFoundException ex) {
        ApiError apiError = new ApiError(INTERNAL_SERVER_ERROR);
        apiError.setMessage("Security Role not found");
        return buildResponseEntity(apiError);
    }
    ...
    private ResponseEntity<Object> buildApiResponseEntity(ApiResponse response, HttpStatus status) {
